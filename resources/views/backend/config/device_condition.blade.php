...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">Device Condition List</h4>
            ...
            <div class="modal-content">
                <form id="productForm2" name="productForm2" class="form-horizontal">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel2">Create New Device Condition</h5>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="productForm" name="productForm" class="form-horizontal">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Device Condition Info</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="device_condition_id" id="device_condition_id">
                        <div class="form-group">
                            <label>Device Condition</label>
                            <input type="text" class="form-control" id="device_condition_name" name="name" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
@section('footer_js')
    ...
    <script type="text/javascript">
        var table = $(".data-table").DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('view/all/device/conditions') }}",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
    ...
    <script>
        ...
        $('#saveBtn').click(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ url('create/new/device/condition') }}",
                type: "POST",
                dataType: 'json',
        ...
        $('#updateBtn').click(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ url('update/device/condition') }}",
                type: "POST",
                dataType: 'json',
                success: function (data) {
