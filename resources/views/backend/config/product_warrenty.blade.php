                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <label id="customFilter">
                            <button class="btn btn-success btn-sm" id="addNewFlag" style="margin-left: 5px"><i class="feather-plus"></i> Add Warrenty Type</button>
                            <a href="{{url('rearrange/warrenty')}}" class="btn btn-info btn-sm" style="margin-left: 5px"><b><i class="fas fa-sort-amount-up"></i> Rearrange</b></a>
                        </label>
