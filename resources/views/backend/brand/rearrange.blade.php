...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">Rearrange Manufacturers by Dragging them</h4>
                    ...
                    <form action="{{url('save/rearranged/brands')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <ol class="clearfix">
                            ...
                            <li style="background: #{{rand(1000,9999)}};">
                                <input type="hidden" value="{{$brand->slug}}" name="slug[]">
                                {{$sl++}}) {{$brand->name}} [{{$brand->slug}}]
                            </li>
                            @endforeach
                        </ol>
