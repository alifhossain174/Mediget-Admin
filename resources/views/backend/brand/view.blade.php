...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">Manufacturer List</h4>
                    <div class="table-responsive">

                        <label id="customFilter">
                            <a href="{{url('add/new/brand')}}" class="btn btn-success btn-sm" id="addNewFlag" style="margin-left: 5px"><i class="feather-plus"></i> Add New Manufacturer</a>
                            <a href="{{url('rearrange/brands')}}" class="btn btn-info btn-sm" style="margin-left: 5px"><b><i class="fas fa-sort-amount-up"></i> Rearrange Manufacturers</b></a>
                        </label>
