...
class ConfigController extends Controller
{
    ...
    public function viewAllFlags(Request $request){
        ...
        return view('backend.config.flag');
    }
    ...
    public function rearrangeFlags(){
        ...
        return view('backend.config.flag_rearrange', compact('flags'));
    }
    public function saveRearrangedFlags(Request $request){
        ...
        Toastr::success('Flags have been Rerranged', 'Success');
